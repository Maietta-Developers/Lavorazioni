...
namespace Zayko.Finance
{
    ...
    public sealed class CurrencyConverter
    {
        ...
        private const string urltemplate = "http://www.ecb.europa.eu/stats/eurofxref/eurofxref-daily.xml";
            ...
            try
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        {
                            xn = allCurr[i];
                            if (xn.Attributes.Count > 0 && xn.Attributes["currency"] != null && xn.Attributes["currency"].Value.ToString()  == "GBP")
                            {
